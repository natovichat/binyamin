...
{
    public partial class SearchGetfrequencyByType
    {
        IDispatcher current;
      
        partial void SearchGetfrequencyByType_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
        ...
        private string GetCSV()
        {
            ...
            foreach (frequencyView view in this.GetfrequencyViewByType)
            {
