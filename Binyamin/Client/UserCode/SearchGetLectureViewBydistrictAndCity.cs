...
{
    public partial class SearchGetLectureViewBydistrictAndCity
    {
        IDispatcher current;
        partial void SearchGetLectureViewBydistrictAndCity_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            DateTime begin;
        ...
        private string GetCSV()
        {
            ...
            foreach (LectureView view in this.GetLectureViewBydistrictAndCity)
            {
