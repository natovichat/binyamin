...
{
    public partial class SearchGetfrequencyByDistrictAndType
    {
        IDispatcher current;
        partial void SearchGetfrequencyByDistrictAndType_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
        ...
        private string GetCSV()
        {
            ...
            foreach (frequencyView view in this.GetfrequencyViewByDistrictAndType)
            {
