...
{
    public partial class SearchGetSummaryYearViewBYYearAndMonth
    {
        IDispatcher current;
        partial void SearchGetSummaryYearViewBYYearAndMonth_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            DateTime begin, end;
        ...
        private string GetCSV()
        {
            ...
            /*foreach (SummaryYear view in this.GetSummaryYearViewBYYearAndMonth)
            {
