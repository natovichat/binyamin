...
{
    public partial class SearchGetfrequencyBYDistrictAndAud
    {
        IDispatcher current;
        partial void  SearchGetfrequencyBYDistrictAndAud_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        ...
        private string GetCSV()
        {
            ...
            foreach (frequencyView view in this.GetfrequencyViewBYDistrictAndAud)
            {
