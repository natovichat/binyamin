...
{
    public partial class SearchGetfrequencyByAud
    {
        IDispatcher current;
        partial void SearchGetfrequencyByAud_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
        ...
        private string GetCSV()
        {
            ...
            foreach (frequencyView view in this.GetfrequencyViewByAud)
            {
