...
{
    public partial class SearchReportLectureAllData
    {
        IDispatcher current;
        partial void SearchReportLectureAllData_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            DateTime begin;
        ...
        {
            this.NumberOfActivities = ReportSchoolViews.Count;
        } 
