...
{
    public partial class SearchGetLectureViewByCity
    {
        IDispatcher current;
        partial void SearchGetLectureViewByCity_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            DateTime begin;
        ...
        private string GetCSV()
        {
            ...
            foreach (LectureView view in this.GetLectureViewByCity)
            {
