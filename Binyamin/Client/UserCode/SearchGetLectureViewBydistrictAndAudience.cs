...
{
    public partial class SearchGetLectureViewBydistrictAndAudience
    {
        IDispatcher current;
        partial void SearchGetLectureViewBydistrictAndAudience_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            DateTime begin;
        ...
        private string GetCSV()
        {
            ...
            foreach (LectureView view in this.GetLectureViewBydistrictAndAudience)
            {
