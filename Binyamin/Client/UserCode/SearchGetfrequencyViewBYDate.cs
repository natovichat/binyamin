...
{
    public partial class SearchGetfrequencyViewBYDate
    {
        IDispatcher current;
        partial void SearchGetfrequencyViewBYDate_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        { 
            DateTime begin;
        ...
        private string GetCSV()
        {
            ...
            foreach (frequencyView view in this.GetfrequencyViewBYDate)
            {
        ...
        partial void byAudience_Execute()
        {
            this.Application.ShowSearchGetfrequencyByAud();

        }

        partial void byAudienceAndDistrict_Execute()
        {
            this.Application.ShowSearchGetfrequencyBYDistrictAndAud();

        }

        partial void byType_Execute()
        {
            this.Application.ShowSearchGetfrequencyByType();

        }

        partial void byTypeAndDistrict_Execute()
        {
            this.Application.ShowSearchGetfrequencyByDistrictAndType();

        }

        partial void byDistrict_Execute()
        {
            this.Application.ShowSearchGetfrequencyBYDistrict();
