...
{
    public partial class SearchGetLectureViewByAudience
    {
           IDispatcher current;
        partial void SearchGetLectureViewByAudience_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            DateTime begin;
        ...
        private string GetCSV()
        {
            ...
            foreach (LectureView view in this.GetLectureViewByAudience)
            {
