...
{
    public partial class SearchGetLectureViewByAudienceAndCity
    {
        IDispatcher current;
        partial void SearchGetLectureViewByAudienceAndCity_InitializeDataWorkspace(List<IDataService> saveChangesTo)
        {
            DateTime begin;
        ...
        private string GetCSV()
        {
            ...
            foreach (LectureView view in this.GetLectureViewByAudienceAndCity)
            {
